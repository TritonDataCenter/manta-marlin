 ...
 *
 *     [ bucket_label, record_key, record_value, [options] ]
 *
 * where bucket_label is the friendly name (e.g., 'task', not 'marlin_tasks'),
 * record_value is the actual value to store, and "options" may contain an etag
 * on which to predicate the write.  EtagConflict errors will be retried a
 ...
 */
MorayBus.prototype.putBatch = function (records, callback)
{
	/* XXX MANTA-928 implement me, "callback" should be optional */
};
