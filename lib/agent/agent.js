...
var mod_agent_meter = require('./meter');
...
mAgent.prototype.tick = function ()
{
	...
	if (!this.ma_task_checkpoint.tooRecent())
		this.tasksCheckpoint();
 ...
 * executing.
 */
mAgent.prototype.tasksCheckpoint = function ()
{
	var agent = this;

	this.ma_log.debug('tasks checkpoint: start');
	...
	this.ma_log.debug('tasks checkpoint: done');
...
function maTaskStream(agent, stream_id, group, machine)
{
	...
	this.s_stats = new mod_agent_meter.StatAccumulator({
