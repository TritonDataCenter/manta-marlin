...
function maZoneCleanupServer(zone, callback)
{
	...
	zone.z_log.info('closing server');
	...
	waiters.forEach(function (w) {
		/* XXX Does this leak? */
		zone.z_log.info('forcibly terminating client connection');
		w['response'].destroy();
...
{
	zone.z_log.info('cleaning up hyprlofs mount');
	zone.z_hyprlofs.removeAll(function (err) {
		...
		zone.z_hyprlofs.unmount(callback);
	});
}
...
function maZoneReadyHyprlofs(zone, callback)
{
	...
	zone.z_log.info('creating hyprlofs mount');
