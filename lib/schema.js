...
var sMorayTask = {
	...
	'properties': {
		...
		'mantaComputeId': sString,
		/* TODO: Change to required */
		'agentGeneration': sString,
...
var sMorayTaskInput = {
	...
	'properties': {
		...
		'serverGeneration': sStringRequiredNonEmpty,
		/* TODO: Change to required */
		'mantaComputeId': sString, /* assigned server */
		/* TODO: Change to required */
		'agentGeneration': sString,
		'input': sStringRequiredNonEmpty,	/* input object name */
...
sBktConfigs['taskinput'] = {
	...
	'retryServer':			{ 'type': 'string' },
	'retryServerGeneration':	{ 'type': 'string' },
