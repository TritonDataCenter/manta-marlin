 ...
 * should have been validated previously.
 *
...
function createMoray(args)
{
	...
	return (new RemoteMoray({ 'conf': args['conf'], 'log': args['log'] }));
}
...
{
	/*
	 * XXX As an optimization, we could use last_id to avoid querying for
