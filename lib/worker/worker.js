 ...
 *
 * XXX There are two sources for new etags: the result of a PUT operation, and
 * the result of a poll operation.  In each case, how do I know which result is
 * the most recent?
 */
 ...
 * XXX MANTA-928: almost certainly want some caching and piggy-backing here
 */
...
Worker.prototype.dispLocate = function (dispatch)
{
	...
	/* XXX MANTA-928: add piggy-backing */
...
{
	var which, server, zonename, task, value, origin_value;
...
Worker.prototype.dispReduce = function (dispatch)
{
	...
	phase = job.j_phases[pi];
	/* XXX MANTA-928: remember to set this in taskCommit or equiv */
	/* XXX MANTA-928 and check for out of range, too (EJ_INVAL) */
	/* XXX MANTA-928 also d_p0objname */
