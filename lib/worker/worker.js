...
mwWorker.prototype.onJob = function (metadata, job)
{
	...
	if (this.mw_jobs.hasOwnProperty(jobid))
		/*
		 * Ignore jobs we already know about.  We'll see records for all
		 * jobs that we own for their duration, at least until we have a
		 * more efficient way to query Moray.
		 */
		return;
