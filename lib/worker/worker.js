...
function Worker(args)
{
	...
	this.w_manta = mod_manta.createClient({
		...
		/*
		 * XXX This will not be used because we'll be passing a per-job
		 * token authorization header with each request.  We should
		 * modify manta-client to not require this.
		 */
		callback(null, {
		    'user': 'poseidon',
		    'keyId': 'none',
